...
export default function ComparePage() {
  ...
  return (
    <>
      <header className="page-header"><div><p className="eyebrow">RESULTS EXPLORER</p><h1>Compare runs</h1><p>Overlay thermo series and expose provenance differences.</p></div></header>
