...
export default function SettingsPage() {
  ...
  return (
    <>
      ...
      <section className="panel cli-help"><h2>Connect a workstation or cluster</h2><pre><span>$</span> python3 -m pip install --user --upgrade '{window.location.origin}/downloads/zph-latest.tar.gz'{"\n"}<span>$</span> zph login {window.location.origin}{"\n"}<span>$</span> zph --upgrade <small># for future updates</small></pre></section>
    </>
  );
}
